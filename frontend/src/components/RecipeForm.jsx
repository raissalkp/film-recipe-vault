...
export default function RecipeForm() {
  ...
  const [form, setForm] = useState({
    name: '', film_simulation: 'Classic Chrome', dynamic_range: 'DR100',
    highlight_tone: 0, shadow_tone: 0, colour: 0, sharpness: 0,
    noise_reduction: 0, white_balance: 'Auto', wb_shift_red: 0,
    wb_shift_blue: 0, tags: '', notes: ''
  })
  ...
  return (
    <div className="form-wrap">
      ...
      <label>Name
        <input value={form.name} onChange={e => set('name', e.target.value)} placeholder="e.g. Japan All-Rounder" />
      </label>
